                ...
                <div className="sidepanel-inner d-flex flex-column">
                    ...
                    <div className="app-branding">
                        <a className="app-logo" href="index.html">
                            <span className="logo-text">GTL Technical Assesment</span></a>
                    ...
                    <nav id="app-nav-main" className="app-nav app-nav-main flex-grow-1">
                        <ul className="app-menu list-unstyled accordion" id="menu-accordion">
                            ...
                            <li className="nav-item has-submenu">
                                <a className={isSubActive(props.history, "posts")} href="#" data-bs-toggle="collapse"
                                ...
                                <div id="submenu-1" className="collapse submenu submenu-1"
                                    ...
                                    <ul className="submenu-list list-unstyled">
                                        <li className="submenu-item">
                                            <Link to={ROUTES.view_posts} className={isSubLinkActive(props.history, ROUTES.view_posts)} >View Posts</Link>
                                        </li>
